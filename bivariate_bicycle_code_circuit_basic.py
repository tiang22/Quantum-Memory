...
def get_bivariate_bicycle_code_circuit_memory_basic(
    l,  # subsystem A size
    m,  # subsystem B size
    a_list,
    b_list,
    ...
    def add_infidelity(circuit, targets, basis):
        if infidelity > 0:
