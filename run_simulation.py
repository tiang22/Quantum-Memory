...
from bivariate_bicycle_code_circuit_basic_no_cycles import (
    ...
    def generate_tasks(basis):
        for l, m, a_list, b_list, d in zip(
            ...
            for p in p_list:
                ...
                if not no_pc:
                    yield sinter.Task(
                        circuit=get_bivariate_bicycle_code_circuit_memory_basic_no_cycles(
                            l,
                            m,
                            a_list,
                            b_list,
...
if __name__ == "__main__":
    ...
    """bb_sim_basic(
        ...
        10 ** (-4.5),
        64,
        path="results/bb_sim_basic_no_pc_50000_100_10000_7_all_errors.csv",
        no_pc=True,
        bp_iters=10000,
        osd_ord=7,
    )"""

    """bb_sim_basic_no_cycles(
        [6],
        [6],
        [[3, 1, 2]],
        [[3, 1, 2]],
        ...
        10 ** (-4.5),
        64,
        path="results/bb_sim_basic_no_cycles_no_pc_50000_100_10000_7.csv",
        no_pc=True,
        bp_iters=10000,
        osd_ord=7,
    )"""
