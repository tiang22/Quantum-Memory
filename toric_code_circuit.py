...
def get_toric_code_circuit_memory(
    d,
    rounds,
    qubit_coherent_time,
    gate_1_time,
    ...
    pos_to_qubit = lambda i, j: (i % (2 * d)) * (2 * d) + (
        j % (2 * d)
    )  # for wrapping around
    data_qubit_to_pos = {}
    X_qubit_to_pos = {}
    ...
    if basis == "Z":
        ...
        circuit.append_from_stim_program_text(
            ...
            + "".join(
                [
                    f" rec[{rec_data_lookup[pos_to_qubit(0, j)]}]"
                    for j in range(1, d * 2, 2)
                ]
            )
        )
        circuit.append_from_stim_program_text(
        ...
        circuit.append_from_stim_program_text(
            ...
            + "".join(
                [
                    f" rec[{rec_data_lookup[pos_to_qubit(1, i)]}]"
        ...
        circuit.append_from_stim_program_text(
            ...
            + "".join(
                [
                    f" rec[{rec_data_lookup[pos_to_qubit(i, 1)]}]"
                    for i in range(0, d * 2, 2)
                ]
            )
        )
